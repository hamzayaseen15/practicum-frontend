...
import { APP_NAME, USER_TYPE } from '@src/constants'
      ...
      <Row className="auth-inner m-0">
        ...
        <Col className="d-flex align-items-center auth-bg px-2 p-lg-5" lg="4" sm="12">
          <Col className="px-xl-2 mx-auto" xs="12" sm="8" md="6" lg="12">
            ...
            <Form className="auth-register-form mt-2" onSubmit={form.handleSubmit(handleSubmit)}>
              <div className="mb-1">
                <HookFormInput name="name" label="Name" placeholder="Enter you name" form={form} />
              </div>
              ...
              <div className="mb-1">
                <HookFormInput name="phone" label="Phone" placeholder="Enter you phone" form={form} />
              </div>

              <div className="mb-1">
                <HookFormInput name="address" label="Address" placeholder="Enter you address" form={form} />
              </div>
